...
int input_set_root(char* input_file,
  ...
  int n_extensions = 8;                    //Keep this as the length of the below list
  char* output_extensions[8] = {"cl.dat","pk.dat","tk.dat","parameters.ini","background.dat","thermodynamics.dat","perturbations_k0.dat","primordial_Pk.dat"};
...
int input_read_parameters_general(struct file_content * pfc,
  ...
  if (flag1 == _TRUE_) {
    if ((strstr(string1,"newtonian") != NULL) || (strstr(string1,"Newtonian") != NULL) || (strstr(string1,"new") != NULL)) {
      ...
      class_stop(errmsg,
                 "You specified the gauge as '%s'. It has to be one of {'newtonian','synchronous'}.",string1);
    }
  }
...
int input_read_parameters_primordial(struct file_content * pfc,
  ...
  /** Define local variables */
  int flag1, flag2, flag3, flagP1, flagP2, flagP3, flag4, flag5, flag6, flag7, flag8, flag9, flag10, flagN, flagP4, flagP5, flagP6, flagP7, flagP8, flagP9, flagP10;
  double param1, param2, param3, paramP1, paramP2, paramP3, param4, param5, param6, param7, param8, param9, param10, paramP4, paramP5, paramP6, paramP7, paramP8, paramP9, paramP10;
  int paramN;
  char string1[_ARGUMENT_LENGTH_MAX_];
  ...
  if (ppm->primordial_spec_type == reconstruction_Pk) {
    ...
    class_call(parser_read_double(pfc,"k_1",&param1,&flag1,errmsg),
                 errmsg,
                 errmsg);
    ppm->k_1 =param1;
    

    class_call(parser_read_double(pfc,"Pk_1",&paramP1,&flagP1,errmsg),
                 errmsg,
                 errmsg);
    ppm->Pk_1 =paramP1;
    

    class_call(parser_read_double(pfc,"k_2",&param2,&flag2,errmsg),
                 errmsg,
                 errmsg);
    ppm->k_2 =param2;   


    class_call(parser_read_double(pfc,"Pk_2",&paramP2,&flagP2,errmsg),
                 errmsg,
                 errmsg);
    ppm->Pk_2 =paramP2;   
    
    
    class_call(parser_read_double(pfc,"k_3",&param3,&flag3,errmsg),
                 errmsg,
                 errmsg);
    ppm->k_3 =param3;  
    
    
    class_call(parser_read_double(pfc,"Pk_3",&paramP3,&flagP3,errmsg),
                 errmsg,
                 errmsg);
    ppm->Pk_3 =paramP3;   
       
    
    class_call(parser_read_double(pfc,"k_4",&param4,&flag4,errmsg),
                 errmsg,
                 errmsg);
    ppm->k_4 =param4;  
    
    
    class_call(parser_read_double(pfc,"Pk_4",&paramP4,&flagP4,errmsg),
                 errmsg,
                 errmsg);
    if (paramP4 != 0){
      ppm->Pk_4 =paramP4;   
    ...
    class_call(parser_read_double(pfc,"k_5",&param5,&flag5,errmsg),
                 errmsg,
                 errmsg);
    if (param5 != 0){
      ppm->k_5 =param5;  
    ...
    class_call(parser_read_double(pfc,"Pk_5",&paramP5,&flagP5,errmsg),
                 errmsg,
                 errmsg);
    if (paramP5 != 0){
      ppm->Pk_5 =paramP5;   
    ...
    class_call(parser_read_double(pfc,"k_6",&param6,&flag6,errmsg),
                 errmsg,
                 errmsg);
    if (param6 != 0){
      ppm->k_6 =param6;  
    ...
    class_call(parser_read_double(pfc,"Pk_6",&paramP6,&flagP6,errmsg),
                 errmsg,
                 errmsg);
    if (paramP6 != 0){
      ppm->Pk_6 =paramP6;   
    ...
    class_call(parser_read_double(pfc,"k_7",&param7,&flag7,errmsg),
                 errmsg,
                 errmsg);
    if (param7 != 0){
      ppm->k_7 =param7;  
    ...
    class_call(parser_read_double(pfc,"Pk_7",&paramP7,&flagP7,errmsg),
                 errmsg,
                 errmsg);
    if (paramP7 != 0){
      ppm->Pk_7 =paramP7;   
    ...
    class_call(parser_read_double(pfc,"k_8",&param8,&flag8,errmsg),
                 errmsg,
                 errmsg);
    if (param8 != 0){
      ppm->k_8 =param8;  
    ...
    class_call(parser_read_double(pfc,"Pk_8",&paramP8,&flagP8,errmsg),
                 errmsg,
                 errmsg);
    if (paramP8 != 0){
      ppm->Pk_8 =paramP8;   
    ...
    class_call(parser_read_double(pfc,"k_9",&param9,&flag9,errmsg),
                 errmsg,
                 errmsg);
    if (param9 != 0){
      ppm->k_9 =param9;  
    ...
    class_call(parser_read_double(pfc,"Pk_9",&paramP9,&flagP9,errmsg),
                 errmsg,
                 errmsg);
    if (paramP9 != 0){
      ppm->Pk_9 =paramP9;   
