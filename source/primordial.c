...
/*
FUNCTION FOR RECONSTRUCTING POWER SPECTRUM WITH SPLINE


*/

int primordial_reconstruction_spectrum(
  ...
  double Pks[ppm->N_knots];
  double ks[ppm->N_knots];
...
int primordial_init(
  ...
  else if (ppm->primordial_spec_type == reconstruction_Pk) {
